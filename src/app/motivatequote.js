...
projects = [
  ...
  'url': 'https://github.com/swathyjayaseelan/PayItForward',
  'source': 'https://github.com/swathyjayaseelan/PayItForward',
  'img': '/app/img/neighbourhoodmap.png'
  },
  {
  'name': 'Neighbourhood Map',
  'desc': '-A single-page web application using Knockout framework featuring a map showing tourist attractions  in Orange County with map  markers to identify popular locations to visit in OC, Search function to easily discover popular locations,-       Listview to support simple browsing of all locations, and Yelp reviews about each location.',
...
profile = [
  {
    'range': 'Currently..',
    'profile':  '<p>Master\'s in Software Engg., <a href="https://www.fullerton.edu/"><i>Cal State Fullerton </i></a>(Graduating Dec\'17)<br/>'+
                '<b><span className="test">CGPA: 4.00</span></b><br/>Full Stack Web Developer Nanodegree, <a href="https://www.udacity.com"><i>Udacity </i></a>(August\'17)<br/>'+
                'Ready to take up new opportunities !!<br/>'+
                '<a href="/contact">Contact me</a></p>'
},
{
  'range': '2016',
  'profile': '<p>Started Master\'s programme at Cal State (January\'16)<br/>'+
              'Front-End Web Developer Nanodegree, <i>Udacity </i><p>'
},
{
  'range': '2015',
  'profile': '<p>Project Manager, <i>Adam & Associates Inc. India </i>(2013-2015)<br/>Duties:<br/>'+
              '<ul><li>Planned and organized project schedules</li><li>Performed detailed assessment of project and resource requirements</li><li>Evaluated estimates, negotiated  budgets and timescales of projects with clients and managers</li></p>'
},
{
  'range': '2014',
  'profile': '<p>Project Manager, <i>Adam & Associates Inc. India </i><br/>'+
              'Diploma In Computer Programming <i>Tiruchirappalli Regional Engineering College Science and Technology Entrepreneurs Park</i><br/>'+
              'Field of study: (C, C++ and Java)</p>'
},
{
  'range': '2013',
  'profile': '<p>Assistant System Engineer, <a href="https://www.tcs.com/"><i>Tata Consultancy Services, India </i></a>(2012-2013)<br/>'+
              'Duties:<br/><ul><li>Deployed applications on WebLogic servers</li>'+
              '<li>Worked as a WebSSO integration engineer integrating applications with WebSSO(Single sign on)</li>'+
              '<li>Provided L2 level support in analyzing and resolving problems</li>'+
              '<li>Mentored and assisted two interns</li><br/></p>'
},
{
  'range': '2012',
  'profile': '<p>Bachelor of Technology (B.Tech.) Honours, EE., <a href="http://www.sastra.edu/"><i>Shanmugha Arts, Science, Technology and Research Academy, India</i></a><br/>'+
              '<b>CGPA: 9.6</b></br>'+
              'Started career as a system engineer in TCS</p>'
},
  ]
